...
--
.pull-right[
```{r echo=FALSE, eval=TRUE, out.height=400, out.width=700, fig.align='center'}
plot(X, xlab="Tempo", ylab="X", type="b", lty=3)
```
]
---
## Seleção de *Embedding*
...
.pull-right[
```{r, eval=TRUE, echo=FALSE, out.width=500, out.height=400}
