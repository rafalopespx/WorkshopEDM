...
xaringanExtra::use_logo(image_url = "img/logo-IFT.png", 
                        link_url = "https://www.ift.unesp.br",
...
##### github: rafalopespx
.pull.left[
<img src="profile_pick.jpeg", style = "width: 40%"/>]
---
class: left
...
--
```{r plot1, echo=FALSE, out.width="75%"}
...
--
```{r echo=FALSE, out.width="85%", fig.align='center', fig.keep='first'}
...
--
```{r echo=FALSE, out.width="80%", fig.keep='first'}
...
--
```{r echo=FALSE, out.width="80%", fig.align='center', fig.keep='first'}
...
* De forma simples, qualquer sistema dinâmico pode ser reconstruído, baste que se tenha uma **série temporal** desse sistema e faça-se tantos atrasos quanto sejam necessários. 
...
ggplot(data = lorentz, aes(x=time, y=X))+
  geom_line()+
  theme_bw()+
  labs(x = "Tempo",
       y = "X")
